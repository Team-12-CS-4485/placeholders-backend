...
- POST /api/pipeline/s3-transcript-analysis : Runs the full pipeline (S3 -> chunk -> embed -> analyze -> Qdrant)
- POST /api/pipeline/search : Semantic search over indexed transcript chunks via Qdrant
"""
